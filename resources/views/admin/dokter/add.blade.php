    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Tambah Data Dokter</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('adm.dokter.save')}}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-12">
                                                ...
                                                <input name="izin" type="text"
                                                       ...
                                                       id="izin" value="{{old('izin')}}"
                                                       placeholder="Nomor Izin" >
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-lg-12">
                                                <label for="poli" class="form-label">Poliklinik <span
                                                        class="text-danger"> *</span></label>
                                                <select name="poli_id" class="form-control select" id="poli">
                                                    @foreach($dataPoliklinik as $poli)
                                                        <option value="{{base64_encode($poli->id)}}" @if(base64_encode($poli->id) == old('poli_id'))selected @endif>{{strtoupper($poli->name)}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
