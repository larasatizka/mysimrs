                ...
                <div class="col-lg-8">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <p class="mt-3">{{$dataPasien->diagnosis ?? "-"}}</p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <p class="mt-3">{{$dataPasien->deskripsi_tindakan ?? "-"}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h3>Keluhan: <span class="text-danger"> * </span></h3>
                                                <textarea name="keluhan_utama"  class="form-control @error('keluhan_utama') is-invalid @enderror" cols="30"
                                                          rows="3">{{old('keluhan_utama')}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="diagnosis"  class="form-control @error('diagnosis') is-invalid @enderror" cols="30"
