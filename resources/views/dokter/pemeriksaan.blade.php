                                ...
                                <div class="table-responsive table-card mb-4">
                                    <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                                        ...
                                        <tr>
                                                ...
                                                @endif
                                                <td>
                                                <a href="{{route('dokter.pemeriksaan.proses', base64_encode($row->pasien->id))}}"><button class="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> PROSES PASIEN</button></a>
                                                </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
