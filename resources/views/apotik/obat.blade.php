                ...
                <div class="col-lg-2">
                    <div class="flex-shrink-0">
                            <div class="d-flex flex-wrap gap-2">
                                <a href="{{route('apoteker.obat.proses')}}"><button class="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i>TAMBAH OBAT</button></a>
                            </div>
                        </div>
                </div><br><br>
                        ...
                        <div class="card" id="ticketsList">
                            ...
                            <div class="card-header border-0">
                                <div class="d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1">DAFTAR OBAT</h5>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card mb-4">
                                    <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                                        <thead>
                                        <tr>
                                            <th class="sort text-center" data-sort="nama_pasien" style="width: 10%">KODE OBAT</th>
                                            <th class="sort text-center" data-sort="nama_pasien" style="width: 10%">NAMA OBAT</th>
                                            <th class="sort text-center" data-sort="nama_pasien" style="width: 10%">KEKUATAN</th>
                                            <th class="sort text-center" data-sort="nama_pasien" style="width: 10%">GOLONGAN</th>
                                            <th class="sort text-center" data-sort="nama_pasien" style="width: 10%">KATEGORI</th>
                                            <th class="sort text-center" data-sort="nama_pasien" style="width: 10%">STOK</th>
                                            <th class="sort text-center" data-sort="nama_pasien" style="width: 10%">HARGA</th>
                                        </tr>
                                        </thead>
                                        ...
                                        <tr>
                                                ...
                                                <td class="text-center">{{$row->kekuatan ?? ""}}</td>
