                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card mb-4">
                                    <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                                        ...
                                        <tr>
                                                <td class="id" ><a href="{{route('apoteker.detailpasien',base64_encode($row->pasien->id))}}" class="fw-medium link-primary">#{{$row->pasien->kode_pasien ?? "0"}}</a></td>
                                                ...
                                                @endif
                                                <td>
                                                <a href="{{route('apoteker.resep.input', base64_encode($row->id))}}"><button class="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> INPUT RESEP</button></a>
                                                </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
