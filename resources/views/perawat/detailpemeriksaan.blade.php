    ...
    <div class="page-content">
        <div class="container-fluid">
                    ...
                    <div class="card ">
                        ...
                        <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="{{route('perawat.pemeriksaan')}}">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card ">
                        <form action="{{route('perawat.pemeriksaan.selesai')}}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="tekanan_darah" id="tekanan_darah"
                                                    class="form-control @if($errors->has('tekanan_darah')) is-invalid @endif" placeholder="mmHg" value="{{old('tekanan_darah')}}" maxlength="6">
                                            </div>
                                        </div>
