                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card mb-4">
                                    <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                                        <thead>
                                        <tr>
                                            <th class="sort text-center" data-sort="id" style="width: 15%">DETAIL</th>
                                            ...
                                            <th class="sort text-center" data-sort="keluhan" style="width: 15%">ALAMAT</th>
                                            <th class="sort text-center" data-sort="status" style="width: 15%">STATUS</th>
                                            <th class="sort text-center" data-sort="status" style="width: 15%">ACTION</th>
                                        </tr>
                                        </thead>
                                        <tbody class="list form-check-all" id="ticket-list-data">
                                        @foreach($dataRekam as $row)
                                        <tr>
                                                <td class="id" ><a href="{{route('perawat.detailpasien',base64_encode($row->pasien->id))}}" class="fw-medium link-primary">#{{$row->pasien->kode_pasien ?? "0"}}</a></td>
                                                ...
                                                <td class="text-center">{{$row->pasien->alamat ?? ""}}</td>

                                                @if($row->status != 2)
                                                <td class="text-center"><span class="badge bg-warning-subtle text-warning text-uppercase">Waiting</span></td>
                                                @else
                                                <td class="text-center"><span class="badge bg-successs-subtle text-success text-uppercase">Done</span></td>
                                                @endif
                                                <td>
                                                <a href="{{route('perawat.pemeriksaan.proses', base64_encode($row->pasien->id))}}"><button class="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> PROSES PASIEN</button></a>
                                                </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
